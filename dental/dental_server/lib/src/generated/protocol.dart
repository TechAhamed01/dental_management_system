...
import 'package:dental_server/src/generated/auth/dentist.dart' as _i13;
import 'package:dental_server/src/generated/auth/patient.dart' as _i14;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i13.Dentist>) {
      return (data as List).map((e) => deserialize<_i13.Dentist>(e)).toList()
          as T;
    }
    if (t == List<_i14.Patient>) {
      return (data as List).map((e) => deserialize<_i14.Patient>(e)).toList()
          as T;
    }
    try {
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i9.Dentist:
        return _i9.Dentist.t;
      case _i11.Patient:
        return _i11.Patient.t;
    }
    return null;
  }
