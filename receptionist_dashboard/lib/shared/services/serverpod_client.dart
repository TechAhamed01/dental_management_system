...
class ReceptionistAuthKeyProvider implements RefresherClientAuthKeyProvider {
  ...
  bool _isTokenExpired(String token) {
    try {
      ...
      return false; // Let backend handle real expiration for now
    } catch (_) {
      return true;
    }
  }
...
Future<void> initializeServerpod() async {
  client = Client(
    'http://localhost:8080/',
  )..authKeyProvider = ReceptionistAuthKeyProvider();
}
